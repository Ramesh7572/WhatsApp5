...
public class PhoneLoginActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputPhoneNumber=(EditText)findViewById(R.id.phone_login_activity);
        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    loadingBar.setMessage("Please wait,while you are authenticating your phone..");
        ...
        callbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
        {
            ...
            {
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Please enter correct phone number your country code...", Toast.LENGTH_SHORT).show();
                                   ...
                                   PhoneAuthProvider.ForceResendingToken token)
            {
                ...
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Code has been Sent Your given phone Number..", Toast.LENGTH_SHORT).show();
